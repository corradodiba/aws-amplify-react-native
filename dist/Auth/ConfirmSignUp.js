...
var ConfirmSignUp = /*#__PURE__*/function (_AuthPiece) {
  ...
  _createClass(ConfirmSignUp, [{
    ...
    value: function showComponent(theme) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_AmplifyUI.Wrapper, null, /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
      ...
      }, this.renderUsernameField(theme), /*#__PURE__*/_react["default"].createElement(_AmplifyUI.FormField, {
        theme: theme,
        ...
        required: true,
        testID: _AmplifyTestIDs["default"].AUTH.CONFIRMATION_CODE_INPUT
      }), /*#__PURE__*/_react["default"].createElement(_AmplifyUI.AmplifyButton, {
        theme: theme,
        text: _awsAmplify.I18n.get('Confirm'),
        onPress: this.confirm,
        disabled: !username || !this.state.code,
        testID: _AmplifyTestIDs["default"].AUTH.CONFIRM_BUTTON
