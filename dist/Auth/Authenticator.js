...
var AuthDecorator = /*#__PURE__*/function () {
  ...
  _createClass(AuthDecorator, [{
    ...
    value: function signIn(username, password) {
      var that = this;
      return _awsAmplify.Auth.signIn(username, password).then(function (data) {
...
var Authenticator = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Authenticator, [{
    ...
    value: function handleStateChange(state, data) {
      ...
      var nextAuthState = state === 'signedOut' ? this._initialAuthState : state;
      ...
      if (_awsAmplify.Analytics._config && Object.entries(_awsAmplify.Analytics._config).length > 0) {
        switch (state) {
          case 'signedIn':
    ...
    key: "checkContact",
    value: function () {
      var _checkContact = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(user) {
        var data;
    ...
    value: function render() {
      ...
      var messageMap = this.props.errorMessage || _AmplifyMessageMap["default"]; // If container prop is undefined, default to AWS Amplify UI Container (SafeAreaView)
      // otherwise if truthy, use the supplied render prop
      // otherwise if falsey, use EmptyContainer

      var ContainerWrapper = this.props.container === undefined ? _AmplifyUI.Container : this.props.container || EmptyContainer;
      ...
      var default_children = [/*#__PURE__*/_react["default"].createElement(_Loading["default"], null), /*#__PURE__*/_react["default"].createElement(_SignIn["default"], null), /*#__PURE__*/_react["default"].createElement(_ConfirmSignIn["default"], null), /*#__PURE__*/_react["default"].createElement(_VerifyContact["default"], null), /*#__PURE__*/_react["default"].createElement(_SignUp["default"], {
        signUpConfig: signUpConfig
      }), /*#__PURE__*/_react["default"].createElement(_ConfirmSignUp["default"], null), /*#__PURE__*/_react["default"].createElement(_ForgotPassword["default"], null), /*#__PURE__*/_react["default"].createElement(_RequireNewPassword["default"], null), /*#__PURE__*/_react["default"].createElement(_Greetings["default"], null)];
      var children = (hideDefault ? [] : default_children).concat(props_children).map(function (child, index) {
      ...
      return /*#__PURE__*/_react["default"].createElement(ContainerWrapper, {
        theme: theme
      }, children);
    }
  }]);
